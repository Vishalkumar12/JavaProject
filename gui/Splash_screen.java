...
public class Splash_screen extends javax.swing.JFrame implements Runnable {
    ...
    public void run(){
        try{
            for(i=1;i<=100;i++){
                ...
                if(i==1){
                    label.setText("Intialising Money Management...");
                }
                else if(i==30){
                    label.setText("Collecting Information...");
                }
                else if(i==60){
                    label.setText("Intializing Database....");
                }
                else if(i==90){
                    label.setText("Almost Ready...");
                }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(81, 163, 147));

        jLabel1.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Money Management System");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/images/icons8_Paper_Money_100px_2.png"))); // NOI18N
        ...
        jLabel3.setText("Developed and Designed by Vishal Kumar");

        jLabel4.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/images/icons8_Message_20px_1.png"))); // NOI18N
        jLabel4.setText("Email tyagivishalynr@gmail.com");
